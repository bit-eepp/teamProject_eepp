	...
	<div class="container mt-5">
		<form action="classOpen" name="cform" method="post"
			...
			<div class="form-group row">
				...
				<div class="col-8">
					<div class="input-group">
						...
						<input id="text" name="cTitle" type="text"
							aria-describedby="textHelpBlock" class="form-control">
					</div>
					<span id="textHelpBlock" class="form-text text-muted">40자
						이내로 입력해 주세요.</span>
				</div>
			</div>
			<br>
			...
			<div class="form-group row">
				<label for="transport_instructions" class="col-4 col-form-label">Class강좌
					한 줄 소개</label>
				<div class="col-8">
					<textarea id="transport_instructions" name="cSummary" cols="40"
						rows="2" aria-describedby="transport_instructionsHelpBlock"
						class="form-control"></textarea>
					<span id="transport_instructionsHelpBlock"
						class="form-text text-muted">100자 이내로 입력해 주세요.</span>
				</div>
			</div>
			<br>

			<div class="form-group row">
				<label for="text" class="col-4 col-form-label">Class강좌 대표
					이미지</label>
				<div class="form-group row" align="center">
					<div class="offset-2 col-9">
						<img id="loadImg" /> <input type="file" name="file" id="classImg"
			...
			<div class="form-group row">
				<label for="transport_instructions" class="col-4 col-form-label">Class강좌
					참여 인원</label>
				<div class="col-8">
					<input style="width: 300px; height: 30px;" cols="40" rows="2"
						aria-describedby="transport_instructionsHelpBlock"
						class="form-control" type="number" name="cTotalPeopleCount"
						min="1" max="50" step="1">
				</div>
			</div>
			<br>
				...
				<div class="col-8">
					<div class="container">
						<div class="radio-box">
							...
							<label for="radio-1">IT/개발</label> <input id="radio-2"
								type="radio" name="cCategory" value="workSkill"> <label
								for="radio-2">업무스킬</label> <input id="radio-3" type="radio"
								name="cCategory" value="daily"> <label for="radio-3">일상</label>
							<input id="radio-4" type="radio" name="cCategory"
								value="financialTechnology"> <label for="radio-4">재테크</label>
			...
			<div class="form-group row">
				...
				<div class="col-8">
					<div class="radio-box">
						...
						<label for="radio-6">쉬움</label> <input id="radio-7" type="radio"
							name="cDifficulty" value="normal"> <label for="radio-7">보통</label>
			...
			<div class="form-group row">
				...
				<div class="col-8">
					<input style="width: 300px; height: 30px;" cols="40" rows="2"
						aria-describedby="transport_instructionsHelpBlock"
						class="form-control" type="number" name="cPrice">
				</div>
			</div>
			<br>
			...
			<div class="form-group row">
				<label for="transport_instructions" class="col-4 col-form-label">Class강좌
					준비물</label>
				<div class="col-8">
					<textarea id="transport_instructions" name="cMaterials" cols="40"
						rows="2" aria-describedby="transport_instructionsHelpBlock"
						class="form-control"></textarea>
					<span id="transport_instructionsHelpBlock"
						class="form-text text-muted">없을 시 공란으로 제출해 주세요.</span>
				</div>
			</div>
			<br>
			...
			<div class="form-group row">
				...
				<div class="col-8">
					...
					<span id="transport_instructionsHelpBlock"
						class="form-text text-muted">Class강좌에 대한 상세정보를 입력해 주세요.</span>
				</div>
			</div>
			<br>
		...
		<form name="form1" role="form" method="post">
			<input type="hidden" name="page" value="${cscri.page}" /> <input
				type="hidden" name="perPageNum" value="${cscri.perPageNum}" /> <input
				type="hidden" name="searchType" value="${cscri.searchType}" /> <input
				type="hidden" name="keyword" value="${cscri.keyword}" /> <input
				type="hidden" name="cCategory" value="${cCategory}" />
		</form>
	</div>
