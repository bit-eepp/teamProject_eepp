...
<html>
	...
	<body>
		...
		<!-- 배경음악테스트 시작 -->
		<iframe src="${pageContext.request.contextPath}/img/aboutUs/trackNo1.mp3" allow="autoplay" id="audio" style="display:none"></iframe>
		<audio autoplay loop id="playAudio">
			<source src="${pageContext.request.contextPath}/img/aboutUs/trackNo1.mp3">
		</audio>
		<!-- 배경음악테스트 끝 -->
