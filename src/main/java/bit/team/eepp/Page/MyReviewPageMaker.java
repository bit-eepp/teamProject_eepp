...
public class MyReviewPageMaker {
	...
	private void calcData() {
		endPage = (int) (Math.ceil(cri.getPage_rv() / (double) displayPageNum) * displayPageNum);
	...
	public String makeQuery(int page_rv) {
    	// 페이지 이동을 위한 함수
        UriComponents uriComponentsBuilder = UriComponentsBuilder.newInstance().queryParam("page_rv", page_rv)
